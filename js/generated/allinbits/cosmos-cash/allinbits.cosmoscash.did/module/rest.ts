...
export type DidMsgAddServiceResponse = object;

export type DidMsgAddVerificationResponse = object;

export type DidMsgCreateDidDocumentResponse = object;

export type DidMsgDeleteServiceResponse = object;

export type DidMsgRevokeVerificationResponse = object;

export type DidMsgSetVerificationRelationshipsResponse = object;

export type DidMsgUpdateDidDocumentResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryDidDocuments = (
    ...
    this.request<DidQueryDidDocumentsResponse, RpcStatus>({
   ...
   */
  queryDidDocument = (id: string, params: RequestParams = {}) =>
    this.request<DidQueryDidDocumentResponse, RpcStatus>({
