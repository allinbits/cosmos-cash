...
const baseIdentifierPacketData: object = { id: 0 };

export const IdentifierPacketData = {
  encode(
    message: IdentifierPacketData,
  ...
  decode(input: Reader | Uint8Array, length?: number): IdentifierPacketData {
    ...
    const message = { ...baseIdentifierPacketData } as IdentifierPacketData;
