...
const txClient = async (wallet, { addr: addr } = { addr: "http://localhost:26657" }) => {
    ...
    return {
        ...
        msgCreateVerifiableCredential: (data) => ({ typeUrl: "/allinbits.cosmoscash.verifiablecredential.MsgCreateVerifiableCredential", value: data }),
        msgDeleteVerifiableCredential: (data) => ({ typeUrl: "/allinbits.cosmoscash.verifiablecredential.MsgDeleteVerifiableCredential", value: data }),
    };
};
