...
export type VerifiablecredentialMsgCreateVerifiableCredentialResponse = object;

export type VerifiablecredentialMsgDeleteVerifiableCredentialResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryVerifiableCredentials = (
    ...
    this.request<VerifiablecredentialQueryVerifiableCredentialsResponse, RpcStatus>({
  ...
  queryVerifiableCredential = (verifiableCredentialId: string, params: RequestParams = {}) =>
    this.request<VerifiablecredentialQueryVerifiableCredentialResponse, RpcStatus>({
