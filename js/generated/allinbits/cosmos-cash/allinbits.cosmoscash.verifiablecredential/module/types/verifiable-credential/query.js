...
export class QueryClientImpl {
    ...
    VerifiableCredentials(request) {
        ...
        const promise = this.rpc.request("allinbits.cosmoscash.verifiablecredential.Query", "VerifiableCredentials", data);
    ...
    VerifiableCredential(request) {
        ...
        const promise = this.rpc.request("allinbits.cosmoscash.verifiablecredential.Query", "VerifiableCredential", data);
