...
declare const txClient: (wallet: OfflineSigner, { addr: addr }?: TxClientOptions) => Promise<{
    ...
    msgCreateVerifiableCredential: (data: MsgCreateVerifiableCredential) => EncodeObject;
    msgCreateIssuerVerifiableCredential: (data: MsgCreateIssuerVerifiableCredential) => EncodeObject;
}>;
