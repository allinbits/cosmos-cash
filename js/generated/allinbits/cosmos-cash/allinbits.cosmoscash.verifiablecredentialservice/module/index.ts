...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgCreateVerifiableCredential: (data: MsgCreateVerifiableCredential): EncodeObject => ({ typeUrl: "/allinbits.cosmoscash.verifiablecredentialservice.MsgCreateVerifiableCredential", value: data }),
    msgCreateIssuerVerifiableCredential: (data: MsgCreateIssuerVerifiableCredential): EncodeObject => ({ typeUrl: "/allinbits.cosmoscash.verifiablecredentialservice.MsgCreateIssuerVerifiableCredential", value: data }),
