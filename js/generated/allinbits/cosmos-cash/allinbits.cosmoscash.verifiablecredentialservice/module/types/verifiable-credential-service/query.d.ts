...
export declare const QueryValidateVerifiableCredentialRequest: {
    encode(message: QueryValidateVerifiableCredentialRequest, writer?: Writer): Writer;
    decode(input: Reader | Uint8Array, length?: number): QueryValidateVerifiableCredentialRequest;
    ...
    fromPartial(object: DeepPartial<QueryValidateVerifiableCredentialRequest>): QueryValidateVerifiableCredentialRequest;
};
...
export interface Query {
    ...
    ValidateVerifiableCredential(request: QueryValidateVerifiableCredentialRequest): Promise<QueryValidateVerifiableCredentialResponse>;
}
