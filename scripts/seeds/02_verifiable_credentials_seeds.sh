...
cosmos-cashd tx verifiablecredentialservice create-issuer-verifiable-credential did:cash:$(cosmos-cashd keys show validator -a) issuer-new-verifiable-cred-3 --from validator --chain-id cash -y
