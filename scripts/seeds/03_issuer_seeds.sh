...
cosmos-cashd tx issuer mint-token did:cosmos:net:cash:vasp did:cosmos:net:cash:eurolicense-credential 9999seuro --from validator --chain-id cash -y
...
cosmos-cashd tx issuer burn-token did:cosmos:net:cash:vasp did:cosmos:net:cash:eurolicense-credential 10000seuro --from validator --chain-id cash -y
