...
cosmos-cashd tx verifiablecredential create-kyc-verifiable-credential \
	did:cosmos:cash:user2 did:cosmos:cred:kyc2 did:cosmos:cash:vasp secret 1000 1000 1000  \
	--from validator --chain-id cash -y
...
cosmos-cashd tx verifiablecredential create-kyc-verifiable-credential \
	did:cosmos:cash:vasp did:cosmos:cred:kyc3 did:cosmos:cash:vasp secret 1000 1000 1000  \
	--from validator --chain-id cash -y
