...
type Verification struct {
	...
	Relationships []VerificationRelationship `protobuf:"varint,1,rep,packed,name=relationships,proto3,enum=allinbits.cosmoscash.identifier.VerificationRelationship" json:"relationships,omitempty"`
...
func (m *Verification) GetRelationships() []VerificationRelationship {
	if m != nil {
...
type MsgSetVerificationRelationships struct {
	...
	Relationships []VerificationRelationship `protobuf:"varint,3,rep,packed,name=relationships,proto3,enum=allinbits.cosmoscash.identifier.VerificationRelationship" json:"relationships,omitempty"`
...
var fileDescriptor_c7826d264b5e2237 = []byte{
	...
	,
}
...
func (m *Verification) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Relationships) > 0 {
		dAtA3 := make([]byte, len(m.Relationships)*10)
		var j2 int
		for _, num := range m.Relationships {
			for num >= 1<<7 {
...
func (m *MsgSetVerificationRelationships) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Relationships) > 0 {
		dAtA6 := make([]byte, len(m.Relationships)*10)
		var j5 int
		for _, num := range m.Relationships {
			for num >= 1<<7 {
...
func (m *Verification) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType == 0 {
				var v VerificationRelationship
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return ErrIntOverflowTx
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= VerificationRelationship(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				m.Relationships = append(m.Relationships, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if elementCount != 0 && len(m.Relationships) == 0 {
					m.Relationships = make([]VerificationRelationship, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v VerificationRelationship
					for shift := uint(0); ; shift += 7 {
