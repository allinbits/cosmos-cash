...
var (
	...
	ErrIdentifierDoesNotExist           = sdkerrors.Register(ModuleName, 1304, "identifier does not exist in the store")
	ErrIncorrectControllerOfDidDocument = sdkerrors.Register(ModuleName, 1305, "sender is not a controller of the identifier")
