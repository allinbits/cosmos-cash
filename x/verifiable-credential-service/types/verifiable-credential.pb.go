...
type UserCredentialSubject struct {
	...
	HasKyc      bool   `protobuf:"varint,7,opt,name=has_kyc,json=hasKyc,proto3" json:"has_kyc,omitempty"`
}
...
func (m *UserCredentialSubject) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *UserCredentialSubject) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *UserCredentialSubject) GetDateOfBirth() string {
	if m != nil {
...
func (m *UserCredentialSubject) GetNationalId() string {
	if m != nil {
		return m.NationalId
	}
	return ""
...
func (m *UserCredentialSubject) GetPhoneNumber() string {
	if m != nil {
...
var fileDescriptor_7396f4d0b066eb58 = []byte{
	...
	,
}
...
func (m *UserCredentialSubject) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PhoneNumber) > 0 {
		...
		i = encodeVarintVerifiableCredential(dAtA, i, uint64(len(m.PhoneNumber)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.NationalId) > 0 {
		...
		i = encodeVarintVerifiableCredential(dAtA, i, uint64(len(m.NationalId)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.DateOfBirth) > 0 {
		...
		i = encodeVarintVerifiableCredential(dAtA, i, uint64(len(m.DateOfBirth)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Address) > 0 {
		...
		i = encodeVarintVerifiableCredential(dAtA, i, uint64(len(m.Address)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Name) > 0 {
